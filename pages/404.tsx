      ...
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <p className="text-2xl md:text-3xl font-light leading-normal">
            <FormattedMessage
              id="not_found.title"
              description="We could'nt find the page title"
          ...
          <p className="mb-8">
            <FormattedMessage
              ...
              description="We could'nt find the page subtitle"
              defaultMessage="But dont worry, you can find plenty of other things on our homepage."
            />
          </p>
          ...
          <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">
            <FormattedMessage
              id="not_found.button"
              description="We could'nt find the page action button"
